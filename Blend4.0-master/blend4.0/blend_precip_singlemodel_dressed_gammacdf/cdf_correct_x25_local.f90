SUBROUTINE cdf_correct_x25_local(nxa, nya, npct, nstride, nstencil, &
    nmultiply, thresh, conusmask, forecast_cdf, analysis_cdf, &
    forecast, forecast_x25)
...
INTEGER, INTENT(IN) :: nxa, nya, npct, nstride, nstencil, nmultiply
	...
	DO ixa = 1, nxa
		...
		IF (conusmask(ixa,jya) .le. 0) THEN
      	...
      	ELSE
         	...
         	! Loop thru the nstencil x nstencil grid points with  (ixa,jya) in center
