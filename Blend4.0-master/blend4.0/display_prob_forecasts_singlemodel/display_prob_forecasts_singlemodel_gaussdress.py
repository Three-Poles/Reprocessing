...
infile = data_directory+cmodel+'/'+\
    cmodel+'_'+cleade+'h_IC'+cyyyymmddhh+'.nc'
print infile
nc = Dataset(infile)
...
plt.suptitle(r''+cleade+'-h Gaussian-dressed forecasts of '+cthresh_title+' from '+cmodel+\
...
plot_title = cmodel+'_'+cthresh+'_'+cyyyymmddhh+'_'+cleade+'h_gaussdress.pdf'
