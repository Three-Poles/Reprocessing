...
SUBROUTINE quantile_map_x25_gamma2(nxa, nya, nstride, n25, nens_qmap, &
    iadim, ipdim, conusmask, gamma_shape_qmap_forecast, &
...
! generate_dressing_stats_anymodel_gammacdf version
...
! ---- For points in the conus mask, perform the quantile
                    ...
                    ELSE 
                        ...
                        ELSE
                            ...
                            ELSE 
                                CALL gamma_quantile_map(iadim, ipdim, fcst, alpha_fcst, &
                                    beta_fcst, fz_fcst, alpha_anal, beta_anal, &
                                    fz_anal, quantile_table, alpha_values, &
                                    cumprob_values, precip_qmapped)
                                forecast_x25(ktr,ixa,jya) = precip_qmapped
                            ENDIF
