...
!     there is some ugly code in here in that MDL defined the supplemental
!     locations on a larger domain, and I apply the supplemental locations
!     on a smaller domain.
...
! ---- read in the supplemental locations dimension information, defined on a larger domain
!      than the one I use for computations.
...
! ---- do the shifting, excising the necessary part 
!      from the smaller grid and shifing indices.
